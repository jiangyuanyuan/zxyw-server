...
import com.zxyw.common.TokenCache;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> register(User user) {
        ServerResponse validResponse = this.checkValid(user.getUsername(), Const.CHECK_USERNAME);
        if (!validResponse.isSuccess()) {
            return validResponse;
        }
//        validResponse = this.checkValid(user.getEmail(),Const.CHECK_EMAIL);
//        if(!validResponse.isSuccess()){
//            return validResponse;
//        }
